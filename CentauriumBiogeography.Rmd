...
tr
plot(tr, cex = 0.8)
title("Example Centaurium phylogeny")
axisPhylo()

write.tree(tr, file = "centaurium.tree")

trfn = np("centaurium.tree")
moref(trfn)

geogfn = np("centaurium.data")
...
numstates_from_numareas(numareas=6, maxareas=5, include_null_range=TRUE)
#numstates_from_numareas(numareas=6, maxareas=5, include_null_range=FALSE)
...
runslow = TRUE
resfn = "Centaurium_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
# For a slow analysis, run once, then set runslow=FALSE to just 
# load the saved result.
resfn = "Centaurium_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
# PDF plots
#######################################################
pdffn = "Centaurium_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Centaurium M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Centaurium M0_unconstrained"
...
runslow = TRUE
resfn = "Centaurium_DIVALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Centaurium_DIVALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Centaurium_DIVALIKE_vs_DIVALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Centaurium M0_unconstrained"
...
#######################################################
analysis_titletxt ="Centaurium DIVALIKE+J on Psychotria M0_unconstrained"
...
runslow = TRUE
resfn = "Centaurium_BAYAREALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Centaurium_BAYAREALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
...
11. Plotting BAYAREALIKE results

```{r}
pdffn = "Centaurium_BAYAREALIKE_vs_BAYAREALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - BAYAREALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Centaurium M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Centaurium M0_unconstrained"
...
#############################################
# WE HAVE RUN UNTIL HERE#####################
#############################################

13. Now we are going to use the model DEC with dispersal multipliers
...
# load the saved result.
runslow = TRUE
resfn = "Centaurium_DEC_M0_constrained_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
14. Run DEC + J con tasas de dispersion
...
# For a slow analysis, run once, then set runslow=FALSE to just 
# load the saved result.
resfn = "Centaurium_DEC+J_M0_constrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
15. Plotting the results with dispesal rates
...
# PDF plots
#######################################################
pdffn = "Centaurium_DEC_vs_DEC+J_M0_constrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Centaurium M0_constrained"
...
# Plot ancestral states - DECJ
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Centaurium M0_constrained"
...
16. Run DIVA like with dispersal rates
...
runslow = TRUE
resfn = "Centaurium_DIVALIKE_M0_constrained_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
17. Run DIVALIKE + j with dispersal rates
...
resfn = "Centaurium_DIVALIKE+J_M0_constrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
18. Plotting additional results with dispersal rates

```{r}

pdffn = "Centaurium_DIVALIKE_vs_DIVALIKE+J_M0_constrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Centaurium M0_constrained"
...
# Plot ancestral states - DIVALIKE+J
#######################################################
analysis_titletxt ="Centaurium DIVALIKE+J on Psychotria M0_constrained"
...
19. Running BAYAREALIKE with dispersal rates
...
runslow = TRUE
resfn = "Centaurium_BAYAREALIKE_M0_constrained_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
20. And BAYAREALIKE + J with dispersal rates
...
resfn = "Centaurium_BAYAREALIKE+J_M0_constrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
...
21. Plotting BAYAREALIKE results with dispersal rates

```{r}
pdffn = "Centaurium_BAYAREALIKE_vs_BAYAREALIKE+J_M0_constrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - BAYAREALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Centaurium M0_constrained"

# Setup
results_object = resBAYAREALIKEc
scriptdir = np(system.file("extdata/a_scripts", package="BioGeoBEARS"))
...
# Plot ancestral states - BAYAREALIKE+J
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Centaurium M0_constrained"

# Setup
results_object = resBAYAREALIKEjc
scriptdir = np(system.file("extdata/a_scripts", package="BioGeoBEARS"))
...
22. Comparing all results with dispersal rates
...
# We have to extract the log-likelihood differently, depending on the 
# version of optim/optimx
LnL_2 = get_LnL_from_BioGeoBEARS_results_object(resBAYAREALIKEc)
LnL_1 = get_LnL_from_BioGeoBEARS_results_object(resBAYAREALIKEjc)
...
# BAYAREALIKE, null model for Likelihood Ratio Test (LRT)
res2 = extract_params_from_BioGeoBEARS_results_object(results_object=resBAYAREALIKEc, returnwhat="table", addl_params=c("j"), paramsstr_digits=4)
# BAYAREALIKE+J, alternative model for Likelihood Ratio Test (LRT)
res1 = extract_params_from_BioGeoBEARS_results_object(results_object=resBAYAREALIKEjc, returnwhat="table", addl_params=c("j"), paramsstr_digits=4)
...
# load the saved result.
runslow = TRUE
resfn = "Centaurium_DEC_M0_constrained2_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
# For a slow analysis, run once, then set runslow=FALSE to just 
# load the saved result.
resfn = "Centaurium_DEC+J_M0_constrained2_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
# PDF plots
#######################################################
pdffn = "Centaurium_DEC_vs_DEC+J_M0_constrained2_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Centaurium M0_constrained and time periods"
...
# Plot ancestral states - DECJ
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Centaurium M0_constrained and time periods"
...
runslow = TRUE
resfn = "Centaurium_DIVALIKE_M0_constrained2_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Centaurium_DIVALIKE+J_M0_constrained2_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Centaurium_DIVALIKE_vs_DIVALIKE+J_M0_constrained2_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Centaurium M0_constrained and time periods"
...
# Plot ancestral states - DIVALIKE+J
#######################################################
analysis_titletxt ="Centaurium DIVALIKE+J on Psychotria M0_constrained and time periods"
...
runslow = TRUE
resfn = "Centaurium_BAYAREALIKE_M0_constrained2_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Centaurium_BAYAREALIKE+J_M0_constrained2_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
...
```{r}
pdffn = "Centaurium_BAYAREALIKE_vs_BAYAREALIKE+J_M0_constrained2_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - BAYAREALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Centaurium M0_constrained and time periods"
...
# Plot ancestral states - BAYAREALIKE+J
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Centaurium M0_constrained and time periods"
